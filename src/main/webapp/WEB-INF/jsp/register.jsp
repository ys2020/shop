...
<head lang="en">
    ...
    <link rel="stylesheet" href="../../statics/AmazeUI-2.4.2/assets/css/amazeui.min.css" />
    <link href="../../statics/css/dlstyle.css" rel="stylesheet" type="text/css">
...
<div class="login-boxtitle">
    <a href="home/demo.html"><img alt="" src="../../statics/images/logobig.png" /></a>
</div>

<div class="res-banner">
    <div class="res-main">
        <div class="login-banner-bg"><span></span><img src="../../statics/images/big.jpg" /></div>
        <div class="login-box">
                ...
                <div class="am-tabs-bd">
                    ...
                    <div class="am-tab-panel">
                        <form method="post" action="/doregister">
                            ...
                            <div class="user-pass">
                                <label for="passwordRepeat"><i class="am-icon-lock"></i></label>
                                <input type="password" name="passwordRepeat" id="" placeholder="确认密码">
                            </div>
